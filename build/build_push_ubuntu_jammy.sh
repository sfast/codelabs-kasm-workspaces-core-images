...
IMAGE_TAG=jammy
BASE_IMAGE=docker.io/dooqod/ospod-ubuntu-x86-64:jammy
...
podman push --authfile="/home/admin/.docker/authfile.json" localhost/dooqod/ospod-desktop-ubuntu-x86-64:jammy docker.io/dooqod/ospod-desktop-ubuntu-x86-64:jammy